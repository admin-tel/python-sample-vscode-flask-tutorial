[![Build Status](https://dev.azure.com/talythaeluiz/SonarTest/_apis/build/status/admin-tel.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/talythaeluiz/SonarTest/_build/latest?definitionId=1&branchName=master)
